...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardim", "338220834", cli1, c1);		
		Endereco e2 = new Endereco(null, "Avenida Matos", "Apt 303", "Sala 800", "Centro", "38777012", cli1, c2);
		...
		SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy HH:mm"); //mascara de formatacao para instancia uma data
